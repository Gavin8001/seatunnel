...
public class SinkMapperMultiCatalogTransform extends AbstractMultiCatalogMapTransform {

    private final ReadonlyConfig config;

    public SinkMapperMultiCatalogTransform(
    ...
    protected SeaTunnelTransform<SeaTunnelRow> buildTransform(
        ...
        return new SinkMapperTransform(SinkMapperConfig.of(config), table);
    }
}
